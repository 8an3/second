...
import SeaListOptions from './ListOptions';
            ...
            <Box>
                ...
                <Flex>
                    <FormControl as={GridItem} mr='5%' colSpan={[6, 3, null, 2]}>
                        ...
                        <Select placeholder='Select a Trailer'
                            name='trailer'
                            id='trailer'
                            defaultValue='0'
                            value={formData.trailer} // Set the value to the current value in formData
                            onChange={handleInputChange}
                        >
                            <option value='0'>None</option>
                            <option value='2304'>Single - Trailer PKG</option>
                            <option value='3499'>Double - Trailer PKG</option>
                            <option value='2199'>Spark Single - Trailer PKG</option>
                            <option value='3299'>Spark Double- Trailer PKG</option>
                        </Select>
                    </FormControl>
